...
class NewsFeedServiceTest {
    ...
    void test1() {
        ...
        //when
        NewsFeedResponseDto newsFeed = newsFeedService.createNewsFeed(newsFeedRequestDto, user);
        //then
        assertNotNull(newsFeed.getId());
    ...
    void test2() {
        ...
        //when
        NewsFeed newsFeed = newsFeedRepository.findById(Objects.requireNonNull(user).getId()).orElse(null);
